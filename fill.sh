...
# Passamos os argumentos extras. 
# Sugestão: Se seu script Python precisa saber onde está o modelo, 
# você pode passar o caminho aqui ou configurar como default no Python.
python marsfill/cli/fill.py "$@"
